...
export default function SubjectIcon({ id }: { id: string }) {
  return (
    <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded bg-[#f4f4f8] text-[#121117]">
      {icons[id] ?? icons.assistant}
    </span>
  );
}
